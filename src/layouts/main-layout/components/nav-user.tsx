      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              size="lg"
              className="cursor-pointer transition-colors hover:bg-white/10 data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground"
            >
          ...
          >
            ...
            <DropdownMenuGroup>
              <DropdownMenuItem
                asChild
                className="cursor-pointer transition-colors hover:bg-white/10 focus:bg-white/10"
              >
                <Link to="/my-profile">
                  <CircleUserRoundIcon />
                  Hồ sơ cá nhân
            ...
            >
              <LogOutIcon />
              {logoutState.isLoading ? <>Đang đăng xuất <LoadingDots/></> : "Đăng xuất"}
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
